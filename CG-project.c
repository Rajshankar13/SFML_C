...
int main()
{
    RenderWindow app(VideoMode(width, height), "Our Game!");
    ...
    for(int i=1;i<=8;i++)
    {
        ...
        stm<<i;
        t[i].loadFromFile("/Users/atharvaajitagwekar/Desktop/Cgproject/Cgproject/images/"+stm.str()+".png");
        t[i].setSmooth(true);
        object[i].setTexture(t[i]);
    }
    
    Texture bg;
    bg.loadFromFile("/Users/atharvaajitagwekar/Desktop/Cgproject/Cgproject/images/bg.png");
    bg.setRepeated(true);
    ...
    for(int i=0;i<1600;i++)
    {
        ...
        //line.spriteX=-0.7; line.sprite=object[8];
    ...
    while (app.isOpen())
    {
        ...
        if (Keyboard::isKeyPressed(Keyboard::RShift)) speed*=3;
        ...
        Texture car;
        car.loadFromFile("/Users/atharvaajitagwekar/Desktop/Cgproject/Cgproject/images/8.png");
        car.setRepeated(true);
        Sprite carload(car);
        //carload.setTextureRect(IntRect(0,0,5000,411));
        carload.setPosition(575,480);
        app.draw(carload);
